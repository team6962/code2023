...
public class Robot extends TimedRobot {
    ...
    private void runTelescoping(){
        if (utilityJoystick.getRawButton(telescopingButton)){
            if (telescopingEncoder.getPosition() < telescopingLimit){
                telescopingMotor.set(telescopingPower);
            }
        }
